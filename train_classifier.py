...
def prepare_data(args):
    ...
    dataset = Dataset(good_root=args.good_root, not_good_root=args.not_good_root, transform=transform)
...
def train_model(model, train_loader, val_loader,test_loader, args):
    ...
    for epoch in range(args.epochs):
        ...
        log_metrics(epoch, total_loss, train_loader, model, val_loader, test_loader, writer, args)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--good_root", default="archive-enhance/train/good", type=str, help="Path to the good screws folder.")
    parser.add_argument("--not_good_root", default="archive-enhance/train/not-good", type=str,help="Path to the not-good screws folder.")
    parser.add_argument("--test_root", default="archive-enhance/test", type=str, help="Path to the good screws folder.")
